...
MONITOR_URL_HEARTBEAT = 'http://127.0.01:8000/monitor/heartbeat'
...
def send_state_update(node_state: NodeState, election_timeout, time_unit=TimeUnit.SECOND):
    ...
    try:
        ...
        logging.info(f'cannot connect to minitor: {MONITOR_URL_HEARTBEAT}')
...
def send_heartbeat(node_state: NodeState, election_timeout, time_unit=TimeUnit.SECOND):
    ...
    try:
        ...
        logging.info(f'cannot connect to minitor: {MONITOR_URL_STATE_UPDATE}')
